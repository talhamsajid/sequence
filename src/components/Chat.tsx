  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={toggleChat}
          className="fixed bottom-20 right-4 z-40 w-12 h-12 bg-emerald-600 hover:bg-emerald-500 text-white rounded-full shadow-lg flex items-center justify-center transition-all active:scale-95"
